...
| **Offline cache** | `sw.js` precaches the app shell plus **every tile URL** from the manifest. The cache name is bumped when assets change (currently `edc-vegas-2026-v7`). |
